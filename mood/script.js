...
function recognizeFaces(){
    ...
    // 心情與結果    
    const detections2 = await faceapi.detectAllFaces(video1, new faceapi.TinyFaceDetectorOptions()).withFaceLandmarks().withFaceExpressions().asSortedArray().sort(0.8, 1.0)
